...
<body>
    <?php
        ...
        interface IUsuarioLeitor extends IUsuario
        {}

        interface IUsuarioBibliotecario extends IUsuario
        {
        ...
        class UsuarioLeitor extends Usuario implements IUsuarioLeitor
        {
            public function __construct(string $nome, string $email, string $login, string $senha)
            {
